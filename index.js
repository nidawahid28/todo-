    ...
    let taskIndex = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: chalk.greenBright("Enter the 'index no.' of the task you want to delete: "),
        }
    ]);
    ...
    let update_task_index = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: chalk.greenBright("Enter the 'index no' of the task you want to update :")
        },
        {
            name: "new_task",
            type: "input",
